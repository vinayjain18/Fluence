"""
Django settings for fluence project.
...
ALLOWED_HOSTS = ['.vercel.app', 'fluence-cqiy.onrender.com', 'localhost', '*'] 
...
WSGI_APPLICATION = 'fluence.wsgi.application'
